...
from Utils import FILE_PATH_NAME, Actions
...
DATA_PATH = os.path.join(FILE_PATH_NAME) # Path for exported to the data as a numpy arrays
actions = Actions # Actions that we try to detect

no_sequences= 30 # 30 videos worth of data
sequence_length = 30 # videos are going to be 30 frames in length
start_folder = 30 # Folder start

# create all derectorys
